...
int main(void)
{
        ...
        printf("\n処理４：該当領域の色を変更します．\n");
           ...
           printf("Red   のシフト量 [-100,100] = ");  scanf("%d",&rgb[0]);
           printf("Green のシフト量 [-100,100] = ");  scanf("%d",&rgb[1]);
           printf("Blue  のシフト量 [-100,100] = ");  scanf("%d",&rgb[2]);
                ...
                for(x=0; x<width[0]; x++) {
                        if(image[1][x][y][0]==0) {//これだけで青か白かの判定は可能である
                                ...
                                for(color=0; color<3; color++) {
                                        if(image[0][x][y][color]+rgb[color]<0) {
                                                image[0][x][y][color]=0;
                                        }
                                        else if(image[0][x][y][color]+rgb[color]>255) {
                                                image[0][x][y][color]=255;
                                        }
                                        else{
                                                image[0][x][y][color]=image[0][x][y][color]+rgb[color];
                                        }
                                }
                        }
                }
